...
`).join('');
    ...
    calculatePrice(currentSettings) {
        ...
        // 1. Kiểm tra nhạc nền
        const isCustomMusic = currentSettings.music !== './music/happybirthday.mp3';
        if (isCustomMusic) {
            items.push({
    ...
    prepareCompleteSettings(settingsToUse) {
        ...
        const completeSettings = {
            music: settingsToUse.music || './music/happybirtday.mp3',
...
`;
    ...
    getCurrentSettingsFromModal() {
        ...
        try {
            ...
            const modalSettings = {
                music: document.getElementById('backgroundMusic')?.value || './music/happybirtday.mp3',
